      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center max-w-6xl mx-auto px-6 md:px-12 lg:px-16">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-midnight-ink">
          ...
          <div className="lg:col-span-7 flex justify-center">
            <Card
              variant="content"
              className="w-full max-w-[480px] bg-canvas-white border-2 border-midnight-ink rounded-lg shadow-subtle p-6 relative overflow-hidden"
            >
              <div className="flex items-center justify-between pb-4 border-b border-charcoal-border mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-xs font-black text-midnight-ink">
              ...
              <div className="flex flex-col gap-6 relative">
                ...
                {studyLogs.map((log, index) => (
                  ...
                  >
                    ...
                    {/* Circle Indicator */}
                    <div
                      className={`w-[24px] h-[24px] rounded-full border border-charcoal-border flex items-center justify-center shrink-0 ${
                        log.status === "success"
                          ? "bg-accent-green"
                          : log.status === "search"
                            ? "bg-card-saffron"
                            : "bg-card-mint animate-pulse"
                      } shadow-subtle-3`}
                    >
                    ...
                    <div className="p-3 bg-pale-ash border border-charcoal-border rounded-lg shadow-subtle-3 flex-grow">
                      <div className="flex justify-between items-center mb-1 gap-2 flex-wrap">
                        ...
                        <Badge
                          className={`text-[8px] px-1.5 py-0.2 rounded border border-charcoal-border font-black text-midnight-ink shrink-0 ${
                            log.level === "B1"
                              ? "bg-card-saffron"
                              : log.level === "B2"
                                ? "bg-card-mint"
