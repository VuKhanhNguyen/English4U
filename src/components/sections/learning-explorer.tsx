                                      ...
                                      {parsedFamily.map((fam, fIdx) => {
                                        ...
                                        return (
                                          <div key={fIdx} className="py-2.5 px-2 flex flex-col md:flex-row gap-2 md:gap-6 justify-between items-start">
                                            <div className="md:w-[220px] shrink-0 flex items-center gap-1.5 flex-wrap">
                                              ...
                                              {row.example && (
                                                <div className="text-xs text-pale-stone italic mt-1 font-mono">
                                                  {row.example.split("\n").map((exLine: string, exIdx: number) => {
                                                    if (isExampleForForm(exLine, fam, parsedFamily)) {
                                                      return (
                                  ...
                                  return (
                                    <div key={fIdx} className="space-y-2 border-b border-off-black/5 dark:border-white/5 last:border-b-0 pb-3 last:pb-0">
                                      <div className="flex items-center gap-1.5 flex-wrap">
                                        <span className="px-2 py-0.5 rounded bg-teal-500/10 text-teal-600 dark:text-teal-400 text-xs border border-teal-500/20 font-mono font-bold">
                                          {formsStr}
                                        </span>
                                        <span className="px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 text-[10px] border border-emerald-500/20 font-mono font-medium">
                                          {abbreviateType(inferWordType(fam.forms, row.word, row.type))}
