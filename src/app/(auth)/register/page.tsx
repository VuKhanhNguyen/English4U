    ...
    <main className="min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8 relative overflow-hidden bg-paper-canvas text-ink">
      ...
      <div className="w-full max-w-lg relative z-10 py-6">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-ink">{translate("Create an Account")}</h1>
          <p className="text-xs sm:text-sm text-pale-stone dark:text-gray-400 mt-2 font-sans">
            {translate("Join English4U to start your language learning journey")}
          </p>
        </div>
